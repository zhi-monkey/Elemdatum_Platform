...
import org.dubhe.admin.domain.dto.SimpleUserRegisterDTO;
...
public class LoginController {
    ...
    public DataResponseBody register(@Valid @RequestBody SimpleUserRegisterDTO userRegisterDTO) {
        return new DataResponseBody(userService.register(userRegisterDTO));
    }
