...
public class UserCenterController {
    ...
    @ApiOperation("修改密码（管理员用）")
    @PostMapping(value = "/{id}/updatePassByAdmin")
    public DataResponseBody updatePassByAdmin(@PathVariable Long id,@RequestBody UserPassUpdateDTO passUpdateDTO) {
        PasswordEncoder passwordEncoder = PasswordEncoderFactory.getPasswordEncoder();
        // 密码解密
        RSA rsa = new RSA(privateKey, null);
        String newPass = new String(rsa.decrypt(passUpdateDTO.getNewPass(), KeyType.PrivateKey));
