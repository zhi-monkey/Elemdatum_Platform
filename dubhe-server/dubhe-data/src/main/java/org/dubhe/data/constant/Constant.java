...
public class Constant {
    ...
    public static final String DATASET_ORIGIN_PATH = DATASET_ORIGIN_NAME + "/";
    public static final String DATASET_ANNOTATION_NAME = "annotation";
    public static final String DATASET_ANNOTATION_PATH = DATASET_ANNOTATION_NAME + "/";
     ...
     * 默认切分版本号
     */
    public static final String DEFAULT_SPLIT_VERSION = "S0001";
     ...
     * 数据集切分版本号前缀
     */
    public static final String DATASET_SPLIT_VERSION_PREFIX = "S";

    public static final String DATA_TYPE_RULE = "数据类型参数不对,请使用: 0-图片 1-视频 2-文本 3-表格 4-语音 100-自定义导入";

    public static final String ANNOTATE_TYPE_RULE = "数据标注类型参数不对, 请使用: 102-目标检测 101-图像分类 201-目标跟踪 301-文本分类 103-目标分割 401-声音分类 402-语音识别 10001-自定义导入";
     ...
     * 数据集名称路径
     */
    public static final String DATASET_PATH_NAME = "dataset" + "/";

    /**
     * 版本文件路径
     */
    public static final String VERSION_PATH_NAME = "/" + "versionFile" + "/";

    /**
     * 标注文件路径
     */
    public static final String ANNOTATION_PATH_NAME = "/" + "annotation";

    /**
     * 当前目录下的全部
     */
    public static final String ALL_IN_THE_CURRENT_DIRECTORY = "/" + "*";
    ...
    public static final String DATASET_ANNOTATED_IMAGE_COUNT_KEY = "dataset:annotated:image:count";
