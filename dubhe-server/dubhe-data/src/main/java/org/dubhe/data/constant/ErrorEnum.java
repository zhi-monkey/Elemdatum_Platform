...
public enum ErrorEnum implements ErrorCode {
    ...
    DATASET_OCCUPIED_BY_MULTI_ANNO(1314, "数据集被多人标注任务占用，无法删除,被占用的数据集id为："),
    FILE_UNZIP_ERROR(1315, "文件解压失败"),
    ...
    DATASET_SAMPLING(1708, "数据集抽帧采样中,请稍等"),
    ...
    DATASET_ZIP_IMPORTING(1723,"数据集导入中,请稍等"),
    DATASET_AUTO_LABELING(1723,"数据集自动标注中,请稍等"),
    ...
    DATASET_VERSION_NOT_EXIST(1805, "数据集版本不存在"),
    DATASET_VERSION_NOT_PUBLISH(1806, "数据集版本未发布"),
