...
@NoArgsConstructor
@AllArgsConstructor
@ApiModel(value = "PcFileSearch dto", description = "点云文件检索")
public class PcFileSearchDTO implements Serializable {
    ...
    @ApiModelProperty(value = "排序字段：id/name/updateTime/fileSize/pointCount")
