...
public class Dataset {
    ...
    @ApiModelProperty(value = "在开始新的操作之前的状态 102:标注中, 105:已标注, 302:抽帧中, 401:数据增强中, 403:导入中, 103:自动标注中")
    ...
    @ApiModelProperty(value = "用于标记是否正在发布中：false(0) 未处于发布中; true(1) 发布中")
    @TableField(value = "is_publishing")
    ...
    public Dataset(DatasetCreateDTO datasetCreateDTO) {
        ...
        this.isPublic = datasetCreateDTO.getIsPublic();
        this.isGuided = datasetCreateDTO.getIsGuided();
    }
