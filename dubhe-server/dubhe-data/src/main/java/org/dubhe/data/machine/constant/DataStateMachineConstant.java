...
public class DataStateMachineConstant {
     ...
     * 压缩包导入
     */
    public static final String ZIP_IMPORT_EVENT = "zipImportEvent";
    /**
     * 压缩包导入完成
     */
    public static final String ZIP_IMPORT_FINISH_EVENT = "zipImportFinishEvent";
    /**
     * 自动标注完成 自动标注中 --> 标注中/标注完成
     */
    public static final String DATA_AUTO_ANNOTATIONS_FINISH_EVENT = "automaticLabelingFinishEvent";


    public static final String DATA_AUTO_AUTO_LABEL_COMPLETE_EVENT = "autoLabelCompleteEvent";
    /**
     * 导入失败
     */
    public static final String IMPORT_ERROR_EVENT = "importErrorEvent";

    public static final String ENHANCE_ERROR_EVENT = "enhanceErrorEvent";
