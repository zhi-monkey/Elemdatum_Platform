...
public interface DatasetVersionFileService {
    ...
    List<DatasetVersionFile> findByDatasetIdAndVersionNameWithoutStatus(Long datasetId, String versionName);
     ...
     * @param versionName 版本名称
     */
    void deleteStatus01ByDatasetAndVersion(Long datasetId, String versionName);
     ...
     * @param versionName 版本名称
     */
    void resetChangedByDatasetAndVersion(Long datasetId, String versionName);
     ...
     */
    Map<Long, DatasetVersionFile> batchGetDatasetVersionFile(Long datasetId, String versionName, List<Long> fileIds);
    ...
    void updateStatusByIds(Integer annotationStatus, Long datasetId, List<Long> ids);
    ...
    void deleteByFileIds(Long datasetId, List<Long> fileIds);

    /**
     * 统计图片标记情况
     * @return  DatasetVersionFileLabelStatVO 图片标记情况
     */
    DatasetVersionFileLabelStatVO countByFileAnnotate();

    /**
     * 根据文件ID批量获取版本文件信息
     */
    Map<Long, DatasetVersionFile> getVersionFileMapByFileIds(Long datasetId, String versionName, List<Long> fileIds);

    /**
     * 批量更新状态
     */
    void updateStatusBatch(List<DatasetVersionFile> datasetVersionFiles);

    Integer getTotalFileCountByDatasetIds(List<Long> datasetIds);
}
