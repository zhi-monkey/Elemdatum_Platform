...
public interface LabelService {
    ...
    /**
     * @param appZipPath 算法包路径
     * @return {@link List }<{@link Long }> 返回值为标签ID集合
     */
    List<Long> saveLabelByReadFile(String appZipPath);

    List<Label> findLabelByIds(List<Long> labelIds);
}
