...
@Component
public class GuidedConvertSuccessFormatter implements NotificationFormatter {

    @Override
    public NotificationOperationTypeEnum supportType() {
        return NotificationOperationTypeEnum.GUIDED_CONVERT_SUCCESS;
    }
    ...
    public String format(String payload) {
        try {
            ...
            return String.format("【引导式】【%s】转换任务执行成功！", generationName);
        } catch (Exception e) {
            return "引导式转换任务执行成功";
        }
    }
