...
public class ModelDTO {
    ...
    /**
     * 算法发布状态（0=待审核、1=审核通过、2=审核未通过）
     */
    private Integer releaseStatus;
    public static Integer REVIEWING = 0;
    public static Integer APPROVED = 1;
    public static Integer DENIED = 2;
    /**
     * 监控文件类型
     */
    ...
    private ModelGenerationDTO modelGenerationDTO;
