...
import {_via_video_thumbnail} from "./_via_video_thumbnail.js"
import {
...
_via_temporal_segmenter.prototype._toolbar_init = function() {
  ...
  // var keyboard_shortcut2 = document.createElement('span');
  // keyboard_shortcut2.setAttribute('class', 'text_button');
  // keyboard_shortcut2.innerHTML = 'Keyboard Shortcuts';
  // keyboard_shortcut2.addEventListener('click', function() {
