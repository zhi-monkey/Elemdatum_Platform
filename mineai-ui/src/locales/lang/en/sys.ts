export default {
  ...
  login: {
    ...
    visitorNotification:
      'You are currently a visitor. Please contact the administrator to modify your role permissions',
    ...
    accountSpaceError: 'Username cannot have leading or trailing spaces',
    passwordSpaceError: 'Password cannot contain any spaces',
