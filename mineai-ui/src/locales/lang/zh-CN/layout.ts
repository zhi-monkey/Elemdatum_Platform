export default {
  ...
  header: {
    ...
    dropdownItemEngineerBrochure: '工程手册',
    dropdownItemNotifications: '查看消息',
    dropdownItemUserBrochure: '用户手册',
    dropdownItemVideoTutorial: '演示视频',
    dropdownItemDeveloperBrochure: '开发手册',
