<template>
  <div class="flex flex-row">
    <div class="flex py-1">
      <span style="font-size: medium">数据集视频信息</span>
    </div>
  </div>
    ...
    <div style="width: 100%; height: 250px">
      ...
      <div class="pt-2 flex justify-center">
        <CountTo
          ...
          :startVal="0"
          class="text-4xl"
          :endVal="data.totalVideos"
        />
      </div>
      <div class="flex space-x-14 justify-center flex-wrap pt-10 pb-3">
        <div class="flex space-x-2">
          <span style="font-size: medium; opacity: 1">已抽帧</span>
          <CountTo
            style="color: #218cfc; font-size: large; font-weight: bold"
            :startVal="0"
            :endVal="data.labeledVideos"
          />
        </div>

        <div class="flex space-x-2">
          <span style="font-size: medium; opacity: 1">未抽帧</span>
          <CountTo
            style="color: #9aa297; font-size: large; font-weight: bold"
            :startVal="0"
            :endVal="data.unlabeledVideos"
          />
        </div>
      </div>
    </div>
