  ...
  <div style="height: 100%; width: 100%">
    <a-card class="p">
      <div class="flex flex-row justify-start w-full">
        <div class="p1 w-1/7">
          <h3 style="font-size: 20px">镜像文件所属算法</h3>
          <a-input
        ...
        <div class="p1 w-2/7">
          <h3 style="font-size: 20px">镜像文件版本号(必填)</h3>
          <a-input
            placeholder="请输入镜像的版本号"
            style="width: 80%; background-color: #303030; font-size: 18px"
            v-model:value="tag"
          />
        </div>
...
<script lang="ts">
  ...
  export default defineComponent({
    ...
    props: { modelName: String, modelEnglishName: String, imageType: String },
    emits: ['next'],
    setup(props, { emit }) {
      ...
      const inputValue = computed(() => props.modelName);

      const filePath = ref('');
      if (props.modelName != null && props.modelEnglishName != null) {
        filePath.value = props.modelEnglishName.toString();
      }
