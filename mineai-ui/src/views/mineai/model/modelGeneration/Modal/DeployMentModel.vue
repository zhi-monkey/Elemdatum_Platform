  ...
  export default defineComponent({
    ...
    setup(_) {
      ...
      const [registerModal, { setModalProps, closeModal }] = useModalInner(async (data) => {
        await resetFields();
        generationId.value = data.record.id;
        console.log(generationId.value);
      ...
      async function handleSubmit() {
        try {
          ...
          deploymentValues['modelGenerationId'] = generationId.value;
          await maHttp
            .get(
              {
          ...
          deploymentValues['monitorId'] = values.monitorId;
          ...
          if (values.architecture === 'amd64') {
            await maHttp.post(
              {
                url: 'modelDeployment/addModelGenerationDeployment',
