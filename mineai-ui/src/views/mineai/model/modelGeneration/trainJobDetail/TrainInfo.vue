      ...
      <a-col :span="12" style="height: 87vh">
        <div style="height: 95%" class="flex flex-col">
          ...
          <a-card title="训练进度" style="height: 15vh; padding-bottom: 4px" class="myCard">
            <i class="flex justify-center">{{ defaultPercent }}%</i>
            <a-progress :percent="defaultPercent" :show-info="false" />
          </a-card>
...
<script lang="ts" setup>
  ...
  async function getPieData(jobId) {
    await maHttp
      ...
      .then((v) => {
        trainAcc.value = v.newNowAcc ? v.newNowAcc : 0;
        recall.value = v.newNowRecall ? v.newNowRecall : 0;
        ...
        setTAP({
          series: {
            ...
            data: [
              {
                value: Number(trainAcc.value.toFixed(2)),
                name: '准确率',
                title: {
                  offsetCenter: ['0%', '-15%'],
                },
        ...
        setRP({
          series: {
            ...
            data: [
              {
                value: Number(recall.value.toFixed(2)),
                name: '召回率',
                title: {
                  offsetCenter: ['0%', '-15%'],
                },
