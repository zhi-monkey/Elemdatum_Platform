          ...
          <a-col :span="12">
            <div style="text-align: left">
              ...
              <a-tooltip trigger="hover">
                <template #title>{{ props?.fullDescription }}</template>
        ...
        <a-row>
          <a-col :span="12">
            <div style="text-align: left">
              <span>监控设备：</span>
              <a-tooltip trigger="hover">
                <template #title>{{ props?.fullMonitorName }}</template>
                <span>{{ props?.monitorName }}</span>
              </a-tooltip>
            </div>
          </a-col>
          <a-col :span="12" style="text-align: left">
            <span>算法名称： </span>
            <a-tooltip trigger="hover">
              <template #title>{{ props?.fullModelName }}</template>
