<template>
  <a-card title="回流文件查看" style="max-width: 1000px">
    <!--    <template #extra>-->
    <!--      <a-input-number placeholder="置信度" style="margin-right: 8px" />-->
    <!--      <a-button type="primary">测试单张图片</a-button>-->
    <!--    </template>-->
    <swiper
      :style="{
...
import { ref } from 'vue';
import { Card as ACard, InputNumber as AInputNumber } from 'ant-design-vue';
