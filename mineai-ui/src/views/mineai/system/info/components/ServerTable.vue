<template>
  <div class="px-2 py-1">
    <div class="flex py-1"
      ><img src="../../../../../assets/icons/titles.svg" alt="title" /><span
...
<script lang="ts" setup>
  ...
  import { getBasicColumns, data, getData } from './serverData';
  ...
  onMounted(async () => {
    ...
    loading.value = false;
    timer1 = setTimeout(() => {
      table = document.querySelector('#serverTable > div > div > div.ant-table-body');
