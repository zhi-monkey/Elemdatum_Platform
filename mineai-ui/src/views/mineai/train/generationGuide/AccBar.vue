...
<script lang="ts" setup>
  ...
  import { currentJobMaxAcc, jobName, newAccSeries } from './detailsData';
  ...
  const getData = async () => {
    console.log('accbar getData');
    data.value = await maHttp.get(
      {
        url: 'log/getTestedDetail',
        params: {
    ...
    data.value['accuracy'].forEach((value) => {
