  ...
  <a-form ref="createFormRef" :model="formState" :rules="rules">
    ...
    >
      <div style="display: flex; align-items: center">
        <!-- a-select 下拉框 -->
        <a-select v-model:value="formState.applicationName" style="flex: 1" disabled>
    ...
    >
      <div style="display: flex; align-items: center">
        <a-select v-model:value="formState.deviceFirmware" style="flex: 1" disabled>
          <a-select-option
...
<script lang="ts" setup>
  ...
  import {
    ...
    getDatasetGroupNameByModelGenerationId,
  ...
  onMounted(async () => {
    ...
    formState.applicationName = props.modelApplication.applicationName.applicationName;
    formState.deviceFirmware =
      props.modelApplication.device.deviceName +
      '-' +
      props.modelApplication.device.firmwareVersion;
    ...
    try {
      ...
      formState.datasetGroup = await getDatasetGroupNameByModelGenerationId(
