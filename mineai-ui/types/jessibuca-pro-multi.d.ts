...
declare class JessibucaProMulti {
   ...
   * @param split
   */
  arrangeWindow(split: number): void;
   ...
   */
  on(
    event: JessibucaProMulti.EVENTS.videoInfo,
    callback: (
      windowIndex: number,
      data: {
        /** 视频宽 */
   ...
   */
  on(
    event: JessibucaProMulti.EVENTS.audioInfo,
    callback: (
      windowIndex: number,
      data: {
        /** 声频通道 */
   ...
   */
  on(
    event: JessibucaProMulti.EVENTS.error,
    callback: (windowIndex: number, err: JessibucaProMulti.ERROR) => void,
  ): void;
   ...
   */
  on(
    event: JessibucaProMulti.EVENTS.kBps,
    callback: (windowIndex: number, value: number) => void,
  ): void;
   ...
   */
  on(
    event: JessibucaProMulti.EVENTS.timeout,
    callback: (windowIndex: number, error: JessibucaProMulti.EVENTS.timeout) => void,
  ): void;
   ...
   */
  on(
    event: JessibucaProMulti.EVENTS.stats,
    callback: (
      windowIndex: number,
      stats: {
        /** 当前缓冲区时长，单位毫秒 */
   ...
   */
  on(
    event: JessibucaProMulti.EVENTS.performance,
    callback: (windowIndex: number, performance: 0 | 1 | 2) => void,
  ): void;
   ...
   */
  on(
    event: JessibucaProMulti.EVENTS.recordingTimestamp,
    callback: (windowIndex: number, timestamp: number) => void,
  ): void;
   ...
   */
  on(
    event: JessibucaProMulti.EVENTS.playbackSeek,
    callback: (
      windowIndex: number,
      times: {
        hour: number;
   ...
   */
  on(
    event: JessibucaProMulti.EVENTS.playbackStats,
    callback: (
      windowIndex: number,
      stats: {
        fps: number;
   ...
   */
  on(
    event: JessibucaProMulti.EVENTS.playbackTimestamp,
    callback: (
      windowIndex: number,
      times: {
        hour: number;
  ...
  on(
    event: JessibucaProMulti.EVENTS.playbackSeek,
    callback: (windowIndex: number, flag: boolean) => void,
  ): void;
   ...
   */
  on(
    event: JessibucaProMulti.EVENTS.ptz,
    callback: (windowIndex: number, flag: string) => void,
  ): void;
   ...
   */
  on(
    event: JessibucaProMulti.EVENTS.zooming,
    callback: (windowIndex: number, flag: boolean) => void,
  ): void;
   ...
   */
  on(
    event: JessibucaProMulti.EVENTS.crashLog,
    callback: (
      windowIndex: number,
      log: {
        url: string;
   ...
   */
  on(
    event: JessibucaProMulti.EVENTS.visibilityHiddenTimeout,
    callback: (windowIndex: number) => void,
  ): void;
